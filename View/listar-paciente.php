                ...
                <table class="table">
                    ...
                    <?php foreach($b as $pessoa){  ?>
                        <tr>
                            ...
                            <td><?=$pessoa->tipo?></td>
                            <td>
                                <a href="/editar-paciente-form?id=<?=$pessoa->id?>" class="fas fa-edit text-dark text-decoration-none mr-2"><span class="glyphicon glyphicon-edit"></span></a>
                                <a href="/apagar-paciente?id=<?=$pessoa->id?>" class="fas fa-eraser text-dark text-decoration-none mr-2"><span class="glyphicon glyphicon-trash"></span></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
