...
<div class="Container">
    <div class="form-row famil1" >
        ...
        <div id="formulario" >
            ...
            <form action="/adcionar-paciente-form" method="post" >
                <div class="form-row">
                    <input name="id_familia" type="text" class="d-none" value="<?=$familia->id?>">
                    ...
                    <div class="col-4 form-group">
                        ...
                        ?>
                    <input name="id" type="text"  class="form-control d-none" value="<?=$endereco->id?>">
